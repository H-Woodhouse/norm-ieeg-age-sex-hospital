...
setwd("../3_output")
regional_summaries = read.csv("regional_age_model_stats.csv")
...
# Sub plots intentionally have missing axes/oddly sized text ready for combining
...
# (sizing will look very odd in R's plotting window, open as pdf from 3_output)
# save
